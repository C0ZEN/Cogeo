(function (angular) {
  ...
  function userFactory($state, CONFIG, $stateParams, httpRequest, usersFactory, localStorageService) {
    ...
    function httpRequestGetUser(callbackSuccess, callbackError) {
      httpRequest.requestGet('user/Cozen', callbackSuccess, callbackError)
      ...
      httpRequest.requestPost('user', data, callbackSuccess, callbackError)
        .then(function (response) {
          ...
          localStorageService.set('currentUser', {
            ...
            token   : response.data.token.login
          });
    ...
    function httpRequestLogout(data, callbackSuccess, callbackError) {
      httpRequest.requestPost('logout', data, callbackSuccess, callbackError);
    }
  }
